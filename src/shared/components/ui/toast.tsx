...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-[calc(100%-1rem)] max-w-[320px] lg:max-w-[280px] flex-col gap-2 rounded-lg border bg-background p-4 shadow-lg transition-all data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-top-[48%]",
  {
    variants: {
      variant: {
